...
# ============================================================
# 国家码 → 中文名 / 大洲 / 国旗（ip-api 兜底时派生用；
# GeoLite2 主路径直接用数据库多语言字段，不走这里）
# ============================================================
...
# 国家码 → 大洲（GeoLite2 continent 中文名口径一致）
COUNTRY_REGION: dict[str, str] = {
    "HK": "亚洲", "MO": "亚洲", "TW": "亚洲", "CN": "亚洲",
    "JP": "亚洲", "KR": "亚洲", "SG": "亚洲", "MY": "亚洲",
    "TH": "亚洲", "PH": "亚洲", "VN": "亚洲", "ID": "亚洲",
    "IN": "亚洲", "TR": "亚洲", "AE": "亚洲", "SA": "亚洲", "IL": "亚洲",
